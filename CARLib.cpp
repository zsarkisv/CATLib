//! @file CaRLib.cpp
//!
//! @note    Библиотека CaRLib.cpp состоит из единственного файла и не требует никаких настроек в среде
...
//{---------------------------------------------------------------------------------------
/// @param width  размер фона по ширине
/// @param height размер фона по высоте
/// @param red    количество красного цвета от 0-255
/// @param green  количество зеленного цвета от 0-255
/// @param blue   количество синего цвета от 0-255
//}---------------------------------------------------------------------------------------
 void drawFon (int width, int height, int red, int green, int blue);

//{---------------------------------------------------------------------------------------
/// @param  x    коортинаты x начала рисования машины
/// @param  y    координаты y начала рисования машины
/// @param  width размер ширины кабины машины
/// @param  height размер длины кабины машины
/// @param  radius размер радиуса колеса
/// @param  ymove  смещение колеса по вертикали
//}---------------------------------------------------------------------------------------
...
//{---------------------------------------------------------------------------------------
///
/// @param x перемещение домика по оси х
///
/// @param y перемещение домика по оси y
//}---------------------------------------------------------------------------------------
...
/// @param x выхлоп автомобиля коортината x

/// @param y выхлоп автомобиля коортината y
